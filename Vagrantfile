...
Vagrant::Config.run do |config|
 ...
 #    chef.add_role "web"
  ...
  #
       chef.cookbooks_path = "/Users/Cultofmetatron/projects/vagrant-guide/cookbooks"
       chef.add_recipe "apt"
       ...
       chef.add_recipe("subhostr")
       chef.add_recipe("subhostr::sites")
